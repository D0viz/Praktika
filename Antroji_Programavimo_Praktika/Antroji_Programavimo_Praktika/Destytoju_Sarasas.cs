...
{
    public partial class Destytoju_Sarasas : Form
    {
        public Destytoju_Sarasas()
        {
            InitializeComponent();
        }
        ...
        public void fillGrid(MySqlCommand command)
        {
            ...
            dataGridView1.DataSource = dest.Destytojo_Informacija(command);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                {
                    if(dest.Destytojo_Info_salinimas(id))
                    {
